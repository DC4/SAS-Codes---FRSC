...
****************************************************
Bypass_LIMIT_BASED_WHITELIST_HK HK DEBIT
****************************************************;
...
(NOT(TRN_POS_ENT_CD IN ("E" "K" "G")) AND CUM_AMOUNT_CP_DAILY <= 1500)
)
);
QUIT;
...
ods listing;
ods excel file='C:\Users\1510806\Desktop\SAS\Outputs\Bypass_LIMIT_BASED_WHITELIST_HK HK DEBIT.xlsx'
...
outfile= "C:\Users\1510806\Desktop\SAS\Outputs\Bypass_LIMIT_BASED_WHITELIST_HK HK DEBIT.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
