...
LIBNAME DS1 "C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\Mar22_NON_MAJOR";
LIBNAME DS2 "C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\Mar22_NON_MAJOR\DRAGON";

 %LET TOD = %SYSFUNC(TODAY());
 %LET MNTH0 = %SYSFUNC(INTNX(MONTH,&TOD.,0),MONYY7.);

DATA CR_DB_DR_FRAUD_Temp;
SET
DS1.last_3_months_data_cr (DROP =  EXTERNAL_1_SCR EXTERNAL_2_SCR EXTERNAL_3_SCR INCOME_AMT PAYMENT_DELINQUENT_CYC)
DS1.last_3_months_data_db (DROP =  EXTERNAL_1_SCR EXTERNAL_2_SCR EXTERNAL_3_SCR INCOME_AMT PAYMENT_DELINQUENT_CYC)
DS2.last_3_months_data_cr (DROP =  EXTERNAL_1_SCR EXTERNAL_2_SCR EXTERNAL_3_SCR INCOME_AMT PAYMENT_DELINQUENT_CYC);
...
DATA CR_DB_DR_FRAUD_3DS1_3DS2;
SET CR_DB_DR_FRAUD;
WHERE (Challenge_Type = 1 OR Challenge_Type = 2) AND FRAUD=1;
RUN; 

PROC EXPORT DATA=CR_DB_DR_FRAUD_3DS1_3DS2
 OUTFILE="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\Mar22_NON_MAJOR\Non_Major_3DS\CR_DB_DR_FRAUD_3DS1_3DS2_Non_Major_&MNTH0..XLSX"
