			...
			*******************************************************************
					       HR_Country_3DS2_MC_RBA Global Debit
...
WHERE  
CRD_CLNT_ID NOT IN ("SC_EURONETIN_DB" "SC_EURONETMY_DB" "SC_EURONETSG_DB" 
"SC_EURONETAE_DB" "SC_HOGANHK_DB" "SC_TANDEMTW_DB" "SC_SPARROWBD_DB") and 
/*CRD_CLNT_ID IN ("SC_HOGANHK_DB") and */
TRN_AUTH_POST = "A";
...
WHERE UPCASE(RULE_NAME_STRG) IN ('HR_COUNTRY_3DS2_MC_RBA') and 
/*CLIENT_XID NOT IN ("SC_HOGANHK_DB") and*/
...
ods listing;
ods excel file='C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\SAS\Outputs\HR_Country_3DS2_MC_RBA Global Debit.xlsx'
...
outfile= "C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\SAS\Outputs\HR_Country_3DS2_MC_RBA Global Debit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
