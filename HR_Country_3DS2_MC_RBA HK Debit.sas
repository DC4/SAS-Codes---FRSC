			...
			*******************************************************************
					       HR_Country_3DS2_MC_RBA HK Debit
...
INC.falt003_db_04nov;
       WHERE UPCASE(RULE_NAME_STRG) IN ('HR_COUNTRY_3DS2_MC_RBA') and CLIENT_XID NOT IN ("SC_HOGANHK_DB") and
...
ods listing;
ods excel file='C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\SAS\Outputs\HR_Country_3DS2_MC_RBA HK Debit.xlsx'
...
outfile= "C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\SAS\Outputs\HR_Country_3DS2_MC_RBA HK Debit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
