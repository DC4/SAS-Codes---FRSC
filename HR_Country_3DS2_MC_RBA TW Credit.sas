			...
			*******************************************************************
					       HR_Country_3DS2_MC_RBA TW Credit
...
CRD_CLNT_ID IN ("SC_CCMSTW_CR") and 
TRN_AUTH_POST = "A";
...
INC.falt003_cr_04nov;
       WHERE UPCASE(RULE_NAME_STRG) IN ('HR_COUNTRY_3DS2_MC_RBA') and CLIENT_XID NOT IN ("SC_CCMSTW_CR") and
...
ods listing;
ods excel file='C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\SAS\Outputs\HR_Country_3DS2_MC_RBA TW Credit.xlsx'
...
outfile= "C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\SAS\Outputs\HR_Country_3DS2_MC_RBA TW Credit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
