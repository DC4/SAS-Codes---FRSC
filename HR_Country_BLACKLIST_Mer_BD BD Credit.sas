...
LIBNAME IND "C:\Users\1510806\Desktop\Jhilam\Daily Data\CR";
...
/*LIBNAME IND "C:\Users\1586087\Documents\Daily_datasets\Credit";*/

DATA  FALT002;
SET IND.falt002_cr_15SEP;   
WHERE  (CRD_CLNT_ID = "SC_C400BD_CR" and TRN_AUTH_POST = "A" and
...
DATA HR_Cntry_BLACKLIST_Mer_BDSAS;
    SET FALT002_2;
    IF (CRD_CLNT_ID = "SC_C400BD_CR" and TRN_AUTH_POST = "A" and
(AUTH_DECISION_XCD = "A" or (AUTH_DECISION_XCD= "" and DECI_CD_ORIG = "A")) and
...
ods listing;
ods excel file='C:\Users\1510806\Desktop\SAS\Outputs\HR_Country_BLACKLIST_Mer_BD BD Credit.xlsx'
...
outfile= "C:\Users\1510806\Desktop\SAS\Outputs\HR_Country_BLACKLIST_Mer_BD BD Credit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
