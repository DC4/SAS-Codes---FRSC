...
**********************************************************
		HR_Global_CNP_5MIN_Test Global Credit
...
LIBNAME CR "C:\Users\1510806\Desktop\Jhilam\Consolidated Last 3 Months Data\Aug21";
...
INC.falt002_cr_28AUG
INC.falt002_cr_29AUG
INC.falt002_cr_30AUG
INC.falt002_cr_31AUG
INC.falt002_cr_01SEP
INC.falt002_cr_02SEP
INC.falt002_cr_03SEP
INC.falt002_cr_04SEP
INC.falt002_cr_05SEP
INC.falt002_cr_06SEP
INC.falt002_cr_07SEP
INC.falt002_cr_08SEP;

     WHERE TRN_AUTH_POST = "A"  AND DATE1 GE "01JUL2021"D AND
 CRD_CLNT_ID IN ("SC_CCMSMY_CR");
...
%MACRO UDV_5MIN(CUM_INTERVAL=, CUMULATIVE_CONDITION =, VAR_NAME=);
DATA FALT002_2;
SET FALT002_2;
...
NOT(SIC_CD IN ("6011" "4900" "6300" "5960" "6381" "6399")) AND
...
CUM_COUNT_CNP_5MIN > 4 AND
CUM_AMOUNT_CNP_5MIN > 50
)
)
...
DATA TXN_DATA;
SET TEMP_TXN_DATA;
WHERE FLAG = "Y" and date1 GE "07SEP2021"D;
RUN;


DATA RULE_DATA;
SET 
INC.falt003_cr_07sep
INC.falt003_cr_08sep;
WHERE UPCASE(RULE_NAME_STRG) IN ('HR_GLOBAL_CNP_5MIN_TEST') and CLIENT_XID IN ("SC_CCMSMY_CR")
and date1 GE "07SEP2021"D;
RUN;

PROC SORT DATA = RULE_DATA NODUPKEY; BY RULE_NAME_STRG FI_TRANSACTION_ID; RUN;

PROC FREQ DATA = TXN_DATA;TITLE "HR_Global_CNP_5MIN_Test  SAS";
TABLE CRD_CLNT_ID*DATE1/NOCOL NOROW NOPERCENT NOCUM; RUN; 

PROC FREQ DATA = RULE_DATA; TITLE "HR_Global_CNP_5MIN_Test  FALCON";
TABLE CLIENT_XID*DATE1/NOCOL NOROW NOPERCENT NOCUM; RUN; 

/* Writing Outout to Excel - For Audit*/

ods listing;
ods excel file='C:\Users\1510806\Desktop\SAS\Outputs\HR_Global_CNP_5MIN_Test Global Credit.xlsx'
...
outfile= "C:\Users\1510806\Desktop\SAS\Outputs\HR_Global_CNP_5MIN_Test Global Credit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
