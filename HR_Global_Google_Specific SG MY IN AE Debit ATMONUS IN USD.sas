...
**********************************************************
		HR_Global_Google_Specific AE IN SG MY Debit
...
DATA FALT002;
SET  
CR.falt002_SG_db_JUL2021
CR.falt002_SG_db_MAY2021
CR.falt002_SG_db_JUN2021
CR.falt002_MY_db_JUL2021
CR.falt002_MY_db_MAY2021
CR.falt002_MY_db_JUN2021
CR.falt002_IN_db_JUL2021
CR.falt002_IN_db_MAY2021
CR.falt002_IN_db_JUN2021
CR.falt002_AE_db_JUL2021
CR.falt002_AE_db_MAY2021
CR.falt002_AE_db_JUN2021
INC.falt002_db_01AUG
INC.falt002_db_02AUG
INC.falt002_db_03AUG
INC.falt002_db_04AUG
INC.falt002_db_05AUG
INC.falt002_db_06AUG
INC.falt002_db_07AUG
INC.falt002_db_08AUG
INC.falt002_db_09AUG
INC.falt002_db_10AUG
INC.falt002_db_11AUG
INC.falt002_db_12AUG
INC.falt002_db_13AUG
INC.falt002_db_14AUG
INC.falt002_db_15AUG
INC.falt002_db_16AUG
INC.falt002_db_17AUG
INC.falt002_db_18AUG
INC.falt002_db_19AUG
INC.falt002_db_20AUG
INC.falt002_db_21AUG
INC.falt002_db_22AUG
INC.falt002_db_23AUG
INC.falt002_db_24AUG
INC.falt002_db_25AUG
INC.falt002_db_26AUG
INC.falt002_db_27AUG;
...
IF 
(
 CRD_CLNT_ID  IN ("SC_EURONETSG_DB" "SC_EURONETMY_DB" "SC_EURONETIN_DB" "SC_EURONETAE_DB") AND
 TRN_AUTH_POST  = "A" AND
 AUTH_DECISION_XCD  = "A" AND
 TRN_TYP IN  ("C" "M" "P") AND
 TRN_POS_ENT_CD IN ("E" "K" "G" "") AND
...
INDEX(UPCASE(MER_NM), "GOOGLE") AND
 ...
 AND
(
(INDEX(UPCASE(MER_NM), "ADS") AND SUBSTR(USERINDICATOR03, 1, 3) not in ("702", "458", "356", "784") AND CUM_AMOUNT_GOOGLE_DAILY > 200) OR
...
WHERE UPCASE(RULE_NAME_STRG) IN ('HR_GLOBAL_GOOGLE_SPECIFIC') and CLIENT_XID IN  ("SC_EURONETSG_DB" "SC_EURONETMY_DB" "SC_EURONETIN_DB" "SC_EURONETAE_DB")
...
ods listing;
ods excel file='C:\Users\1510806\Desktop\SAS\Outputs\HR_Global_Google_Specific AE IN SG MY Debit.xlsx'
...
outfile= "C:\Users\1510806\Desktop\SAS\Outputs\HR_Global_Google_Specific AE IN SG MY Debit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
