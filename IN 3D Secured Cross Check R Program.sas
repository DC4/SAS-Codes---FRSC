...
WHERE  clientIdFromHeader  IN ("SC_EURONETIN_DB" "SC_CCMSIN_CR") AND DATE="05NOV2021"D;
RUN;
...
CREATE TABLE CR AS 
SELECT * FROM 
ch2.falt002_cr_31oct
where substr(usr_ind_4,1,2) = "Y2"  AND DATE1="05NOV2021"D and 
(
...
ods listing;
ods excel file='C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\IN_3D_Secured_05NOV2021.xlsx'
...
outfile= "C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\IN_3D_Secured_05NOV2021.xlsx"
dbms=xlsx replace;
sheet="FRD15";
run;
