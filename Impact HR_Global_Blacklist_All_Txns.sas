...
DATA FALT002;
     SET 
INC1.falt002_DB_30MAY
INC1.falt002_DB_29MAY
INC1.falt002_DB_28MAY;
...
DATA TXN_DATA;
	...
	WHERE FLAG = "Y" AND DATE1 GE "29MAY2021"D;
RUN;

DATA RULE_DATA;
     SET 
	 INC1.falt003_DB_30MAY
INC1.falt003_DB_29MAY;
WHERE UPCASE(RULE_NAME_STRG) IN ('MR_COUNTRY_UBER_TAOBAO_TW_TEST') AND CLIENT_XID IN ("SC_TANDEMTW_DB") AND 
DATE1 GE "29MAY2021"D;
RUN;
