...
**********************************************************
    LR_Global_3DS_Investment_Scam_Test Global Debit
...
LIBNAME DB "C:\Users\1510806\Desktop\Jhilam\Consolidated Last 3 Months Data\Jun21";
LIBNAME INC "C:\Users\1510806\Desktop\Jhilam\Daily Data\DB";

DATA FALT002;
     SET  
DB.last_3_months_data_db
INC.falt002_db_01JUN
INC.falt002_db_02JUN
INC.falt002_db_03JUN
INC.falt002_db_04JUN
INC.falt002_db_05JUN
INC.falt002_db_06JUN
INC.falt002_db_07JUN
INC.falt002_db_08JUN
INC.falt002_db_09JUN
INC.falt002_db_10JUN
INC.falt002_db_11JUN
INC.falt002_db_12JUN
INC.falt002_db_13JUN
INC.falt002_db_14JUN
INC.falt002_db_15JUN
INC.falt002_db_16JUN
INC.falt002_db_17JUN
INC.falt002_db_18JUN
INC.falt002_db_19JUN
INC.falt002_db_20JUN
INC.falt002_db_21JUN
INC.falt002_db_22JUN
INC.falt002_db_23JUN
INC.falt002_db_24JUN
INC.falt002_db_25JUN
INC.falt002_db_26JUN
INC.falt002_db_27JUN
INC.falt002_db_28JUN
INC.falt002_db_29JUN
INC.falt002_db_30JUN
...
INC.falt002_db_04JUL;
	 ...
	 CRD_CLNT_ID NOT IN ("SC_SPARROWBD_DB" "SC_HOGANHK_DB" "SC_TANDEMTW_DB");
...
SUBSTR(USR_IND_4,1,2) = "Y2" AND
SIC_CD IN ("6012" "6051" "6211" "8999")
)
and
(
(
 CRD_CLNT_ID  IN ("SC_EURONETSG_DB" "SC_EURONETMY_DB" "SC_EURONETIN_DB" "SC_EURONETAE_DB") AND
CUM_AMOUNT_CNP_HOURLY > 2000
)
...
CUM_COUNT_CNP_HOURLY >1 AND
 ...
 CUM_AMOUNT_APPR_ATMONUS_DAILY  > 2 *  CUM_AMOUNT_MAX_ATMONUS_DAILY 
)

OR
(
 CRD_CLNT_ID  IN (
"SC_EURONETBN_DB" "SC_SPARROWBW_DB" "SC_SPARROWCI_DB" "SC_SPARROWCM_DB"
"SC_SPARROWGH_DB" "SC_SPARROWGM_DB" "SC_SPARROWJO_DB" "SC_SPARROWKE_DB"
"SC_SPARROWLK_DB" "SC_SPARROWNG_DB" "SC_SPARROWNP_DB" "SC_EURONETQA_DB" 
"SC_SPARROWSL_DB" "SC_SPARROWTZ_DB" "SC_SPARROWUG_DB" "SC_EURONETVN_DB"
"SC_SPARROWZM_DB" "SC_SPARROWZW_DB"
) AND
CUM_COUNT_CNP_HOURLY > 1 AND
 USD  >= 100 AND
 CUM_COUNT_APPR_ATMONUS_DAILY  > 2 *  CUM_COUNT_MAX_ATMONUS_DAILY  AND
...
DATA RULE_DATA;
     SET 
INC.falt003_db_03JUL
INC.falt003_db_04JUL;
       WHERE UPCASE(RULE_NAME_STRG) IN ('LR_GLOBAL_3DS_INVESTMENT_SCAM_TEST') and date1 GE "03JUL2021"D;
RUN;

PROC SORT DATA = RULE_DATA NODUPKEY; BY RULE_NAME_STRG FI_TRANSACTION_ID; RUN;

PROC FREQ DATA = TXN_DATA;TITLE "LR_Global_3DS_Investment_Scam_Test  SAS";
TABLE CRD_CLNT_ID*DATE1/NOCOL NOROW NOPERCENT NOCUM; RUN; 

PROC FREQ DATA = RULE_DATA; TITLE "LR_Global_3DS_Investment_Scam_Test  FALCON";
TABLE CLIENT_XID*DATE1/NOCOL NOROW NOPERCENT NOCUM; RUN; 

/* Writing Outout to Excel - For Audit*/

ods listing;
ods excel file='C:\Users\1510806\Desktop\SAS\Outputs\LR_Global_3DS_Investment_Scam_Test Global Debit.xlsx'
...
outfile= "C:\Users\1510806\Desktop\SAS\Outputs\LR_Global_3DS_Investment_Scam_Test Global Debit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
