						...
						**********************************************************
								  MR_Global_MID_Non_Major_Test Global Debit
...
DATA FALT002;
SET  
INC.falt002_db_02dec(DROP =  EXTERNAL_1_SCR EXTERNAL_2_SCR EXTERNAL_3_SCR INCOME_AMT PAYMENT_DELINQUENT_CYC)
INC.falt002_db_03dec(DROP =  EXTERNAL_1_SCR EXTERNAL_2_SCR EXTERNAL_3_SCR INCOME_AMT PAYMENT_DELINQUENT_CYC);
     WHERE TRN_AUTH_POST = "A"  AND DATE1 GE "01NOV2021"D AND
/* CRD_CLNT_ID IN ("SC_HOGANHK_DB");*/
	  CRD_CLNT_ID NOT IN ("SC_HOGANHK_DB" "SC_TANDEMTW_DB" "SC_SPARROWBD_DB" "SC_EURONETAE_DB"
"SC_EURONETIN_DB" "SC_EURONETSG_DB" "SC_EURONETMY_DB");
...
( TRN_AUTH_POST  = "A" AND
 ...
 COMPRESS(MER_ID) = "MIIGEWVCLPXV49G"
)
...
DATA TXN_DATA;
SET TEMP_TXN_DATA;
WHERE FLAG = "Y" and date1 GE "02DEC2021"D;
RUN;
...
WHERE UPCASE(RULE_NAME_STRG) IN ('MR_GLOBAL_MID_NON_MAJOR_TEST') and CLIENT_XID IN ("SC_SPARROWBW_DB")
and date1 GE "02DEC2021"D;
RUN;

PROC SORT DATA = RULE_DATA NODUPKEY; BY RULE_NAME_STRG FI_TRANSACTION_ID; RUN;

PROC FREQ DATA = TXN_DATA;TITLE "MR_Global_MID_Non_Major_Test  SAS";
TABLE CRD_CLNT_ID*DATE1/NOCOL NOROW NOPERCENT NOCUM; RUN; 

PROC FREQ DATA = RULE_DATA; TITLE "MR_Global_MID_Non_Major_Test  FALCON";
...
ods listing;
ods excel file='C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\SAS\Outputs\MR_Global_MID_Non_Major_Test Global Debit.xlsx'
...
outfile= "C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\SAS\Outputs\MR_Global_MID_Non_Major_Test Global Debit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
...
UPCASE(RULE_NAME_STRG) not IN ('MR_Global_MID_Non_Major_Test');
RUN;
