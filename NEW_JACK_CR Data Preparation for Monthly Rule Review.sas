...
PROC EXPORT DATA=DISP_NOT_TAGGED_AS_FRAUD_CR OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\DISP_NOT_TAGGED_AS_FRAUD_CR.XLSX"
...
PROC EXPORT DATA=STORE.RULE_PERFORMANCE_CR_&MNTH0.
 OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\CONSOLIDATED LAST 3 MONTHS DATA\&MNTH00.\RULE_PERFORMANCE_CR_&MNTH0..XLSX"
DBMS=XLSX REPLACE;RUN;
PROC EXPORT DATA=STORE.FRAUD_CR_&MNTH33._TO_&MNTH11.
 OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\CONSOLIDATED LAST 3 MONTHS DATA\&MNTH00.\FRAUD_CR_&MNTH33._TO_&MNTH11..XLSX"
DBMS=XLSX REPLACE;RUN;
