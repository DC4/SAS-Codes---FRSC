...
PROC EXPORT DATA=DISP_NOT_TAGGED_AS_FRAUD_DB OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\DISP_NOT_TAGGED_AS_FRAUD_DB.XLSX"
...
PROC EXPORT DATA=STORE.RULE_PERFORMANCE_DB_&MNTH0.
 OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\CONSOLIDATED LAST 3 MONTHS DATA\&MNTH00.\RULE_PERFORMANCE_DB_&MNTH0..XLSX"
DBMS=XLSX REPLACE;RUN;
PROC EXPORT DATA=STORE.FRAUD_DB_&MNTH33._TO_&MNTH11.
 OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\CONSOLIDATED LAST 3 MONTHS DATA\&MNTH00.\FRAUD_DB_&MNTH33._TO_&MNTH11..XLSX"
DBMS=XLSX REPLACE;RUN;
