...
FORMAT TENANT $50.;
TENANT = "&NM.";
if rule_name ne "" and STRIP(UPCASE(RULE_SET)) = "DECISION RULESET"	and QAV="BLACKLIST" AND STRIP(UPCASE(PRODUCT))  = "DEBIT 25 AUTHORIZATION-POSTING";
RUN;
...
LIBNAME DEBIT "C:\Users\1510806\Desktop\Jhilam\Falcon 6.4 Monthly Data\debit";

DATA FALT003;
	SET DEBIT.FALT003_&CNTY._DB_&MNTH1.
		DEBIT.FALT003_&CNTY._DB_&MNTH2.
		DEBIT.FALT003_&CNTY._DB_&MNTH3.;
	WHERE STRIP(SUBSTR(CLIENT_XID,LENGTH(CLIENT_XID)-4))="&CNTY._DB";
...
PROC SORT DATA=RULE_PERFORMENCE_DB; BY FI_TRANSACTION_ID RULE_NAME_STRG; RUN;

DATA RULE_PERFORMENCE_DB_1;
LENGTH RULES $ 400 ;
...
PROC EXPORT DATA=SUMM1 OUTFILE="C:\Users\1510806\Desktop\Jhilam\BLACKLIST_MID_DB &mnth1..XLSX"
DBMS=XLSX REPLACE;
SHEET="SUMMARY";
RUN;

PROC EXPORT DATA=RULE_PERFORMENCE_db_1 OUTFILE="C:\Users\1510806\Desktop\Jhilam\BLACKLIST_MID_DB &mnth1..XLSX"
DBMS=XLSX REPLACE;
SHEET="DETAILS";
RUN;
