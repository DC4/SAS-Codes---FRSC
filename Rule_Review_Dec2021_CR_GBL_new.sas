...
%let disputefile = a.dispute_DEC_2021_CR;
%let portfolio = "CREDIT";
%let frd_table = a.FRAUD_CR_SEP21_TO_NOV21;
%let tran_tab = a.LAST_3_MONTHS_DATA_CR;
%let rule_hit_tab = a.RULE_HIT_LAST_3_MONTHS_CR;
%let rule_perf = a.RULE_PERFORMANCE_CR_DEC2021;
...
CASE
WHEN SUBSTR(STRIP(CLIENT_XID),LENGTH(STRIP(CLIENT_XID))-4, 2) NOT IN ("HK" "TW" "BD") THEN "Global" 
...
create a new file named dispute_transaction_apr2021_gbl.xlsx in the below path*/
...
proc import datafile="\\inhadfil101.in.standardchartered.com\wkgrps7\RAC_IN_MIS\Saravana\Monthly Reviews\Falcon\&MNTH1.\Credit\Data from fraudbase_CR_GBL_new.xlsx"
...
select DISTINCT(FI_TRANSACTION_ID) AS TXNID from &rule_hit_tab. where RULE_NAME_STRG in ('HR_GLOBAL_BLACKLIST_MIDS_HOTLIST_CREDIT','HR_Global_Credit_Blacklist_MID');
quit;
...
/*Change the path to where you want to save the excel file*/

/* Splitting and running incase of huge data */
/*DATA DISPUTE_MER_TXN1_1;*/
/*SET DISPUTE_MER_TXN1(OBS=578829);*/
/*RUN;*/
/*DATA DISPUTE_MER_TXN1_2;*/
/*SET DISPUTE_MER_TXN1(FIRSTOBS=578830);*/
/*RUN; */
/*proc export data=DISPUTE_MER_TXN1_1*/
/* outfile="C:\Users\1510806\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\DISPUTE_MER_TXN_CR_GBL_new_1.xlsx"*/
/*dbms=xlsx replace;SHEET="DISPUTE_MER_TXN1_11";run;*/
...
/* outfile="C:\Users\1510806\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\DISPUTE_MER_TXN_CR_GBL_new.xlsx"*/
/*dbms=xlsx replace;run;*/
...
proc export data=DISPUTE_MER_TXN1_1 
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\New folder\DISPUTE_MER_TXN_CR_GBL_new.xlsx" 
dbms=xlsx replace;SHEET="DISPUTE_MER_TXN1_1";run; 
proc export data=DISPUTE_MER_TXN1_2 
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\New folder\DISPUTE_MER_TXN_CR_GBL_new.xlsx" 
dbms=xlsx replace;SHEET="DISPUTE_MER_TXN1_2";run; 


proc export data=all4 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Data from fraudbase_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=RULE_SUMMARY outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Overall rule analysis_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=UNDETECT_SUMMARY outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Undetected case review_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=review_data outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\RUle review data_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=undetect_cases
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months data\&curr_mth.\undetect_cases_CR_GBL_new.xlsx"
dbms=xlsx replace;run;

proc export data=rule_analysis_data_CR1
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\rule_analysis_data_CR_GBL_new.xlsx"
dbms=xlsx replace;run;

proc export data=a.CR_MID_Impact_Summary
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth\CR_MID_Impact_Summary_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=tab2x
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\tab2x_cr.xlsx"
dbms=xlsx replace;run;
proc export data=BLACKLIST_ANALYSIS3
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\BLACKLIST_ANALYSIS3_CR.xlsx"
dbms=xlsx replace;run;