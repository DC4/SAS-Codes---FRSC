...
libname a "C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&MNTH00.";
...
%let rmth = 202111;
%let prev_mth = 202110;
%let prev_mth1 = 202109;
%let prev_mth2 = 202108;
%let rule_segment = a.RULE_SEGMENT;
%let disputefile = a.DISPUTE_DEC_2021_db;
%let portfolio = "DEBIT";
%let frd_table = a.FRAUD_DB_SEP21_TO_NOV21;
%let rule_hit_tab = a.RULE_HIT_LAST_3_MONTHS_DB;
%let rule_perf = a.RULE_PERFORMANCE_DB_DEC2021;
...
proc export data=DISPUTE_MER_TXN1
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\DISPUTE_MER_TXN_DB_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=all4 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Data from fraudbase_DB_GBL_new.xlsx"
dbms=xlsx replace;run;

proc export data=RULE_SUMMARY outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Overall rule analysis_DB_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=UNDETECT_SUMMARY outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Undetected case review_DB_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=review_data outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\RUle review data_DB_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=rule_analysis_data_DB1
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\rule_analysis_data_DB_GBL_new.xlsx"
dbms=xlsx replace;run;

proc export data=undetect_cases
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\undetect_cases_DB_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=a.DB_MID_Impact_Summary
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\DB_MID_Impact_Summary_DB_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=tab2x
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\tab2x_db.xlsx"
dbms=xlsx replace;run;
proc export data=BLACKLIST_ANALYSIS3
 outfile="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\BLACKLIST_ANALYSIS3_DB.xlsx"
dbms=xlsx replace;run;
