...
%let disputefile = a.dispute_MAR_2022_CR;
%let portfolio = "CREDIT";
%let frd_table = a.FRAUD_CR_DEC21_TO_FEB22;
%let tran_tab = a.LAST_3_MONTHS_DATA_CR;
%let rule_hit_tab = a.RULE_HIT_LAST_3_MONTHS_CR;
%let rule_perf = a.RULE_PERFORMANCE_CR_MAR2022;
...
/* outfile="C:\Users\1640982\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\DISPUTE_MER_TXN_CR_GBL_new_1.xlsx"*/
...
/* outfile="C:\Users\1640982\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\DISPUTE_MER_TXN_CR_GBL_new.xlsx"*/
/*dbms=xlsx replace;run;*/
...
proc export data=DISPUTE_MER_TXN1_1 
 outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\New folder\DISPUTE_MER_TXN_CR_GBL_new.xlsx" 
...
proc export data=all4 outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Data from fraudbase_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=RULE_SUMMARY outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Overall rule analysis_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=UNDETECT_SUMMARY outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\Undetected case review_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=review_data outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\RUle review data_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=undetect_cases
 outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months data\&curr_mth.\undetect_cases_CR_GBL_new.xlsx"
dbms=xlsx replace;run;

proc export data=rule_analysis_data_CR1
 outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\rule_analysis_data_CR_GBL_new.xlsx"
dbms=xlsx replace;run;

proc export data=a.CR_MID_Impact_Summary
 outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth\CR_MID_Impact_Summary_CR_GBL_new.xlsx"
dbms=xlsx replace;run;
proc export data=tab2x
 outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\tab2x_cr.xlsx"
dbms=xlsx replace;run;
proc export data=BLACKLIST_ANALYSIS3
 outfile="C:\Users\1640982\OneDrive - Standard Chartered Bank\Desktop\Jhilam\Consolidated Last 3 Months Data\&curr_mth.\BLACKLIST_ANALYSIS3_CR.xlsx"
dbms=xlsx replace;run;