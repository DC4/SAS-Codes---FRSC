...
PROC EXPORT DATA=DISP_NOT_TAGGED_AS_FRAUD_CR OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\CONSOLIDATED LAST 3 MONTHS DATA\HK\DISP_NOT_TAGGED_AS_FRAUD_CR.XLSX"
...
LIBNAME STORE "C:\Users\1510806\Desktop\Jhilam\Consolidated Last 3 Months Data\&MNTH00."; 
...
PROC DELETE DATA=STORE.HK_LAST_1_MONTH_DATA_CR; RUN;
...
PROC APPEND DATA=TXN_DETAILS_&CNTY. BASE=STORE.HK_LAST_1_MONTH_DATA_CR FORCE; RUN;
...
DATA STORE.FRAUD_CR_HK_&MNTH33._TO_&MNTH11.;
SET STORE.HK_LAST_1_MONTH_DATA_CR;
WHERE FRAUD=1;
RUN;
...
PROC EXPORT DATA=STORE.RULE_PERFORMANCE_CR_&MNTH0.
 OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\CONSOLIDATED LAST 3 MONTHS DATA\HK\RULE_PERFORMANCE_CR_&MNTH0..XLSX"
DBMS=XLSX REPLACE;RUN;
PROC EXPORT DATA=STORE.FRAUD_CR_&MNTH33._TO_&MNTH11.
 OUTFILE="C:\USERS\1510806\DESKTOP\JHILAM\CONSOLIDATED LAST 3 MONTHS DATA\HK\FRAUD_CR_&MNTH33._TO_&MNTH11..XLSX"
DBMS=XLSX REPLACE;RUN;
...
FROM STORE.HK_LAST_1_MONTH_DATA_CR
