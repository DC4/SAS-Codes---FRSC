...
PROC DELETE DATA=UDP_RULE_PERFORMENCE_CR; RUN;
...
PROC APPEND DATA=TXN_DETAILS_FRD_&CNTY. BASE=UDP_RULE_PERFORMENCE_CR FORCE; RUN;
...
PROC SORT DATA=UDP_RULE_PERFORMENCE_CR NODUPKEY; BY FI_TRANSACTION_ID RULE_NAME_STRG; RUN;



/*COMMENTS: CHANGE PATH*/

PROC EXPORT DATA=UDP_RULE_PERFORMENCE_CR OUTFILE="C:\Users\1510806\OneDrive - Standard Chartered Bank\Desktop\Jhilam\UDP_RULE_PERFORMENCE_CR.xlsx" DBMS=XLSX REPLACE;
RUN;