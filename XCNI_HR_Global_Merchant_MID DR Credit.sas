...
*************************************************************
				XCNI_HR_Global_Merchant_MID DR Credit
...
DATA  FALT002;
     ...
     WHERE (CRD_CLNT_ID = "SC_PMTHK_CR" and	TRN_AUTH_POST = "A" and 
...
WHERE CLIENT_XID = "SC_PMTHK_CR" and UPCASE(RULE_NAME_STRG) IN ('XCNI_HR_GLOBAL_MERCHANT_MID') and date1 GE "17JUN2021"D;
...
PROC FREQ DATA=TXN_DATA; TITLE "XCNI_HR_Global_Merchant_MID_Test SAS"; 
TABLE TENANT*DATE1/NOCOL NOROW NOPERCENT NOCUM;  RUN;

PROC FREQ DATA=RULE_DATA; TITLE "XCNI_HR_Global_Merchant_MID_Test FALCON HITS"; 
TABLE TENANT*DATE1/NOCOL NOROW NOPERCENT NOCUM; RUN;


ods listing;
ods excel file='C:\Users\1510806\Desktop\SAS\Outputs\XCNI_HR_Global_Merchant_MID DR Credit.xlsx'
 options(sheet_interval="NONE");
 ods excel options(sheet_name="OUTPUT");
PROC FREQ DATA = TXN_DATA;TITLE "XCNI_HR_Global_Merchant_MID SAS";
TABLE CRD_CLNT_ID*DATE1/NOCOL NOROW NOPERCENT NOCUM; RUN; 
PROC FREQ DATA = RULE_DATA; TITLE "XCNI_HR_Global_Merchant_MID FALCON";
TABLE CLIENT_XID*DATE1/NOCOL NOROW NOPERCENT NOCUM; RUN;
ods excel close;
ods listing close;

PROC EXPORT DATA= TXN_DATA
outfile= "C:\Users\1510806\Desktop\SAS\Outputs\XCNI_HR_Global_Merchant_MID DR Credit.xlsx"
dbms=xlsx replace;
sheet="TXN_DATA";
run;
...
UPCASE(RULE_NAME_STRG) not IN ('XCNI_HR_Global_Merchant_MID');
RUN;
...
/*XCNI_HR_Global_Merchant_MID_TEST_RL A LEFT JOIN HR_GLOBAL_MERCHANT_DECLINE_RL B*/
...
/*SELECT A.*,B.RULE_NAME_STRG AS NEW_RULE_NAME_STRG FROM */
/*HR_GLOBAL_MERCHANT_DECLINE_RL A LEFT JOIN XCNI_HR_Global_Merchant_MID_TEST_RL B*/
/*ON A.FI_TRANSACTION_ID = B.FI_TRANSACTION_ID;*/
/*QUIT;*/
/**/
/**/
/*DATA NOT_XCNI_HR_Global_Merchant_MID_TEST;*/
/*SET FALT002;*/
/*WHERE FI_TRANSACTION_ID IN (*/
/*'025d162bf70374a5'*/
/*'025d162bf7037e1f'*/
